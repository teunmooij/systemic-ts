...
export type SystemicBuild<TSystemic extends Record<string, unknown>, TDependencies extends Record<string, unknown>> = [
 ...
 * Systemic system.
 */
export interface Systemic<T extends Record<string, unknown>> {
  /**
   ...
   */
  add: <S extends string, TComponent, TDependencies extends Record<string, unknown> = EmptyObject>(
   ...
   * @param options registration options
   */
  set: <S extends string, TComponent, TDependencies extends Record<string, unknown> = EmptyObject>(
    name: S,
    component: Component<TComponent, TDependencies> | CallbackComponent<TComponent, TDependencies> | TComponent,
    options?: { scoped?: boolean },
  ) => SystemicBuild<
   ...
   */
  configure: <TComponent, TDependencies extends Record<string, unknown> = EmptyObject>(
    component: Component<TComponent, TDependencies> | CallbackComponent<TComponent, TDependencies> | TComponent,
